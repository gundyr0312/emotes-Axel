...
EmoteName.Position = UDim2.new(-0.1, 0.5, 0)
EmoteName.Size = UDim2.new(0.2, 0.2, 0)
...
Grid.CellSize = UDim2.new(0.105, 0)
Grid.CellPadding = UDim2.new(0.006, 0.006, 0)
...
SearchBar.Size = UDim2.new(0.55, 0.1, 0)
...
local Emotes = {
	...
	{ name = "Nicki Minaj Boom", id = 15571538346, icon = "rbxthumb://type=Asset&id=15571538346&w=150&h=150", price = 100, lastupdated = 1704779662, sort = {} },
	...
	{ name = "Monkey", id = 3716630, icon = "rbxthumb://type=Asset&id=3716636630&w=150&h=150", price = 50, lastupdated = 1663281650, sort = {} },
	...
	{ name = "MANIAC - Stray Kids", id = 11309359, icon = "rbxthumb://type=Asset&id=11309309359&w=150&h=150", price = 0, lastupdated = 1668458448, sort = {} },
...
for i,name in pairs(FavoritedEmotes) do
	if typeof(name) == "string" then
		for i,emote in pairs(Emotes) do
			if emote.name == name then table.insert(UpdatedFavorites, emote.id) break end
		end
	end
end
if #UpdatedFavorites ~= 0 then FavoritedEmotes = UpdatedFavorites writefile("FavoritedEmotes.txt", HttpService:JSONEncode(FavoritedEmotes)) end
...
local function CharacterAdded(Character)
	...
	random.MouseButton1Click:Connect(function() local randomemote = Emotes[math.random(1, #Emotes)] PlayEmote(randomemote.name, randomemote.id) end)
	...
	UIStroke.Parent = EmoteNumber
		...
		if table.find(FavoritedEmotes, Emote.id) then Favorite.Image = FavoriteOn else Favorite.Image = FavoriteOff end
